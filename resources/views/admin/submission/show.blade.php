      ...
      <div class="card-body">
        ...
        <form class="custom-validation" method="POST" action="{{ route('admin.submissions.update', $submission->id) }}"
          ...
          <div class="form-group row">
            ...
            <div class="col-sm-10">
              <input class="form-control" type="text" name="number" id="number" value="{{ $submission->number ?? $nomor_surat }}"
                required>
            </div>
          </div>
          ...
          <div class="form-group mb-0">
            <div>
              <button type="button" class="btn btn-success waves-effect waves-light mr-1" onclick="history.back()">
              ...
              <button type="submit" form="form-print-{{ $signatory->id }}"
                ...
                Cetak Sebagai {{ auth('admin')->user()->username }}</button>
              @endforeach
            </div>
          </div>
        </form>
