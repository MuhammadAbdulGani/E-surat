        ...
        <div class="card mini-stat bg-primary text-white">
            <div class="card-body">
                <div class="mb-4">
                    ...
                    <h4 class="font-weight-medium font-size-24">{{ PendingSubmissions()->count() }} <i
        ...
        <div class="card mini-stat bg-primary text-white">
            <div class="card-body">
                <div class="mb-4">
                    ...
                    <h4 class="font-weight-medium font-size-24">{{ ApprovedSubmissions()->count() }} <i
                            class="mdi mdi-arrow-up text-success ml-2"></i></h4>
                </div>
            </div>
        </div>
        ...
        <div class="card mini-stat bg-primary text-white">
            <div class="card-body">
                <div class="mb-4">
                    ...
                    <h4 class="font-weight-medium font-size-24">{{ RejectedSubmissions()->count() }} <i
                            class="mdi mdi-arrow-up text-success ml-2"></i></h4>
                </div>
            </div>
        </div>
        ...
        <div class="card mini-stat bg-primary text-white">
            <div class="card-body">
                <div class="mb-4">
                    ...
                    <h4 class="font-weight-medium font-size-24">{{ PendingSubmissions()->count() + RejectedSubmissions()->count() + ApprovedSubmissions()->count() }} <i
                            class="mdi mdi-arrow-up text-success ml-2"></i></h4>
                </div>
            </div>
        </div>
